...
;(function($){
    ...
    $(document).ready(function(){
        ...
        function ut_isSafari() {
            return /^((?!chrome).)*safari/i.test(navigator.userAgent);
        }
        
        function ut_isChrome() {
            return /chrome/.test(navigator.userAgent.toLowerCase());
        }
        
        /* Background Fix Chrome & Safari
		================================================== */
        var $section = $("section");
        
        function ut_refreshBackgrounds() {
            
           $section.each(function() {
                                   
                var $this = $(this);
                
                if( ut_isSafari() && $this.css('background-attachment') === 'fixed' ) {
                    $this.css('background-attachment','scroll !important');
                }
                
                /* check for background image */
                if ( $this.css('background-attachment') === 'fixed' && $this.css("background-image") && $this.isOnScreen() ) {
                
                    var scrollTop = $(window).scrollTop(),
                        photoTop  = $this.offset().top,
                        distance  = (photoTop - scrollTop),
                        oldBackgroundImage = $this.css("background-image");
                        
                    $this.css("background-image", oldBackgroundImage).css('background-position', 'center ' + (distance*-1) + 'px');
        ...
        if ( ut_isChrome() || ut_isSafari() ) {
            $(window).bind('scroll', ut_refreshBackgrounds);
        }
		...
		$('#navigation a').click( function(event) { 
			...
			if(this.hash && !$(this).hasClass('external') && !$(this).parent().hasClass('external') ) {
		...
		$(document).on("click" , '.ut-hide-member-details, #navigation, .site-logo' , function(event) {
